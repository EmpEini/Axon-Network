...
class axon_network():
    def __init__(self, input_dimension, activation_function):
        '''Inputs:
           ...
           Output:
           The neural network and its attributes.'''
        ...
        if optim_options[0] == 'basinhopping':
            ...
            if optim_options[1] == 'classical':
                x_min = basinhopping(self.func_classical, x_start, niter=70,
                                     T=0.7)
            elif optim_options[1] == 'FokinaOseledets':
                x_min = basinhopping(self.func_FokinaOseledets, x_start,
                                     niter=70, T=0.7)
            ...
            if optim_options[1] == 'classical':
                ...
                x_min = differential_evolution(self.func_FokinaOseledets,
                                               bounds, maxiter=300,
            ...
            if optim_options[1] == 'classical':
                ...
                x_min = dual_annealing(self.func_FokinaOseledets, bounds,
                                       maxiter=250)
            elif optim_options[1] == 'opt':
            ...
            if optim_options[1] == 'classical':
                ...
                x_min = optimizer.minimize(
                                     lambda x: self.func_FokinaOseledets(x))
            elif optim_options[1] == 'opt':
    ...
    def func_FokinaOseledets(self, x):
